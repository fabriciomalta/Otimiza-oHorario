...
ponturanqueado(individuoatual-9:individuoatual,1:2)=sortrows(pontufitness(individuoatual-9:individuoatual,1:2));
...
{
individuomutar=ponturanqueado(individuoatual-9,2);
}
elseif(individuomutarsorteado>=21 && individuomutarsorteado<=39)
{
individuomutar=ponturanqueado(individuoatual-8,2);
}elseif(individuomutarsorteado>=40 && individuomutarsorteado<=56)
{
individuomutar=ponturanqueado(individuoatual-7,2);
}elseif(individuomutarsorteado>=57 && individuomutarsorteado<=67)
{
individuomutar=ponturanqueado(individuoatual-6,2);
}elseif(individuomutarsorteado>=68 && individuomutarsorteado<=77)
{
individuomutar=ponturanqueado(individuoatual-5,2);
}elseif(individuomutarsorteado>=78 && individuomutarsorteado<=85)
{
individuomutar=ponturanqueado(individuoatual-4,2);
}elseif(individuomutarsorteado>=86 && individuomutarsorteado<=91)
{
individuomutar=ponturanqueado(individuoatual-3,2);
}elseif(individuomutarsorteado>=92 && individuomutarsorteado<=96)
{
individuomutar=ponturanqueado(individuoatual-2,2);
}elseif(individuomutarsorteado>=97 && individuomutarsorteado<=99)
{
individuomutar=ponturanqueado(individuoatual-1,2);
}else{
individuomutar=ponturanqueado(individuoatual,2);
}
endif;
